...
(setq window-size-change-functions ; fit fill-column in window
      '((lambda (frame)
...
(use-package doom-modeline
  ...
  :config
  (remove-hook 'after-change-functions ;; Don't change buffer file name face.
               'doom-modeline-update-buffer-file-name-face)
  (remove-hook 'focus-in-hook 'doom-modeline-update-buffer-file-name)
  (advice-remove 'undo 'doom-modeline-update-buffer-file-name)
  (advice-remove 'undo-tree-undo-1 'doom-modeline-update-buffer-file-name)
  (advice-remove 'undo-tree-redo-1 'doom-modeline-update-buffer-file-name)
  (advice-remove 'popup-create 'doom-modeline-update-buffer-file-name)
  (advice-remove 'popup-delete 'doom-modeline-update-buffer-file-name)
  (advice-remove 'pop-to-buffer 'doom-modeline-update-buffer-file-name)
  (advice-remove 'fill-paragraph 'doom-modeline-update-buffer-file-name)
    ...
    (setq desktop-file-modtime
          (nth 5 (file-attributes
                  (desktop-full-file-name
                   (concat my-desktop-session-dir "last-session"))))))
...
(use-package magit
  ...
  (add-hook 'git-commit-setup-hook
            ...
            ;; append to end of git-commit-setup-hook to ensure our hook trumps
            ;; others.
            t))
...
;; Display company completions in an overlay.
