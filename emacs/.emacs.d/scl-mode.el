...
(defvar lua-sexp-alist '(("THEN" . "END_IF")
                      ("function" . "END_IF")
                      ("do" . "END_IF")
                      ("repeat" . "until")))
...
(define-abbrev-table 'lua-mode-abbrev-table
  '(("END_IF"    "END_IF"    lua-indent-line :system t)
    ("ELSE"   "ELSE"   lua-indent-line :system t)
    ("ELSIF" "ELSIF" lua-indent-line :system t)))
...
(defconst lua-block-token-alist
  '(("do"       "\\_<end\\_>"   "\\_<for\\|while\\_>"                       middle-or-open)
    ...
    ("END_IF"      nil           "\\_<\\(do\\|function\\|then\\|else\\)\\_>" close)
        ...
        (let ((found-token (match-string 0))
          ...
          (let ((found-type (lua-get-token-type
            ...
            (if (not (and match (string-match match found-token)))
              ...
              ;; if/ELSIF. Will reset variables instead.
...
use standalone."
  (cond
   ...
   ;; ELSIF is a bit of a hack. It is not handled separately, but it needs to
